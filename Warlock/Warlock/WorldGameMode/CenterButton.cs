...
namespace Warlock
{
    class CenterButton : IDrawable, IInteractable
    {
        ...
        public void Draw()
        {
            ...
            WarlockGame.m_spriteBatch.Draw(WarlockGame.m_textures["mission"], m_buttonPosition, Color.White);
        ...
        public void InteractGesture(GestureSample gesture)
        {
            if (gesture.GestureType == GestureType.Tap
                && gesture.Position.X < m_buttonPosition.X + WarlockGame.m_textures["mission"].Width && gesture.Position.X > m_buttonPosition.X
                && gesture.Position.Y < m_buttonPosition.Y + WarlockGame.m_textures["mission"].Height && gesture.Position.Y > m_buttonPosition.Y)
            {
